...
module.exports = class AutoGitUpdate {
    ...
    async compareVersions() {
        try {
            log.general('Checking for updates...');
    ...
    async forceUpdate() {
        try {
            log.general('Update Found..')
            log.general('Downloading application..');
            await downloadUpdate();
            await backupApp();
            await installUpdate();
            await installDependencies();
            log.general('Finished installing updated version.');
            log.general('Starting JRaffles');
